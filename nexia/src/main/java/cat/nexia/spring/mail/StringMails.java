...
/**
 * Classe estàtic amb els diferents missatges en format HTML que empra l'aplicació
 */
...
public class StringMails {
    ...
    /**
     * Missatge html per a confirmar una reserva
     *
     * @param rsv objecte Reserva
     * @return missatge amb totes les dades
     */
    ...
    /**
     * Missatge html per a confirmar cancelació d'una reserva
     *
     * @param rsv objecte Reserva
     * @return missatge amb totes les dades
     */
    ...
    /**
     * Missatge per a modificar contrasenya
     *
     * @param userId id de l'usuari
     * @return missatge amb les dades de l'usuari
     */
    ...
    /**
     * Missatge de benvinguda d'un nou usuari
     * @param userId id de l'usuari
     * @param username name de l'usuari
     * @param password password de l'usuari
     * @return missatege amb les dades de l'usuari
     */

    public static String cosEmailBenvinguda(long userId, String username, String password) {
        return HEADER +
